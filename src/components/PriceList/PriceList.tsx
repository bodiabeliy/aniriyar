...
import { speakersList, priceList } from "@/utils/data";
...
const PriceList = () => {
  ...
  return (
    <>
      <div className={`${!isMobile ?"PriceListWrapperMobile":"PriceListWrapper"}  relative sm:bg-darkOrangeMoble lg:bg-darkOrange pb-[30px]`}>
                  ...
                  return (
                    <>
                      <div className="cardsBtns-animate rounded-[20px] bg-actionBtns z-10 p-1 w-full max-w-[300px] sm:mb-8 lg:mb-0 m-auto">
                        <div className="rounded-[20px] bg-white flex flex-col justify-center max-w-[300x]">
